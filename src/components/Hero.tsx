      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-[2]">
        <div className="anim-gas-reveal">
          <Image
            ...
            width={600}
            height={450}
            className="w-[200px] sm:w-[280px] md:w-[360px] lg:w-[420px] h-auto opacity-100 select-none"
            priority
            aria-hidden="true"
          />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-24 pb-12 md:pt-36">
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-7">
              ...
              <div className="opacity-0 anim-line delay-3 w-16 h-0.5 bg-gradient-to-r from-primary to-orange-500 mt-8 mb-8" />
              ...
              <div className="opacity-0 anim-fade-up delay-5 flex flex-col sm:flex-row gap-3 mt-10">
                <a
                  ...
                  className="btn-glow group inline-flex items-center justify-center gap-3 bg-primary hover:bg-primary-light text-white font-bold px-8 py-4 text-lg rounded-xl transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-primary/30"
                >
                  {WA_ICON}
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 border border-white/15 hover:border-white/30 text-white/60 hover:text-white font-semibold px-8 py-4 text-lg rounded-xl transition-all duration-300"
                >
