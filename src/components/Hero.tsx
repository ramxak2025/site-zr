          ...
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-7">
              <div className="opacity-0 anim-fade delay-1">
                <div className="badge badge-dark mb-8">
              ...
              <div className="opacity-0 anim-fade-up delay-2">
                <h1 className="text-5xl sm:text-6xl lg:text-7xl xl:text-[5.5rem] font-black text-white leading-[0.92] tracking-tight">
                  Сократите
                  <br />
                  расходы
                  <br />
                  <span className="text-gradient">на топливо</span>
                </h1>
              </div>
              ...
              <div className="opacity-0 anim-fade-up delay-4">
                <p className="text-white/50 text-lg sm:text-xl leading-relaxed max-w-lg">
                  Переведите авто на газ за{" "}
                  <span className="text-white font-medium">1&nbsp;день</span> — каждый километр
                  будет стоить в 2 раза дешевле.
                  <span className="text-white/40"> Итальянское оборудование, гарантия 2 года.</span>
                </p>
              </div>
              ...
              <div className="opacity-0 anim-fade-up delay-5 flex flex-col sm:flex-row gap-3 mt-10">
                <a
                  ...
                  className="btn-glow group inline-flex items-center justify-center gap-3 bg-primary hover:bg-primary-light text-white font-bold px-8 py-4 text-lg rounded-xl transition-all duration-300 hover:-translate-y-0.5"
                >
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 border border-white/15 hover:border-white/30 text-white/70 hover:text-white font-semibold px-8 py-4 text-lg rounded-xl transition-all duration-300"
                >
                  +7 988 444-44-85
                </a>
              </div>
              ...
              <div className="card-dark p-8 relative overflow-hidden">
                ...
                <div className="relative">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <span className="text-white/40 text-sm tracking-widest uppercase font-medium">Стоимость установки</span>
                  </div>
                  ...
                  <div className="mt-6 pt-5 border-t border-white/10">
                    <div className="flex items-center gap-3">
                      <div className="flex -space-x-2">
                        {["bg-primary", "bg-accent", "bg-emerald-500"].map((c, i) => (
                          <div key={i} className={`w-8 h-8 rounded-full ${c} border-2 border-dark-card flex items-center justify-center`}>
