      ...
      <div className="relative z-10 flex-1 flex items-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-28 pb-8 md:pt-32">
          <div className="grid lg:grid-cols-5 gap-12 lg:gap-20 items-center">
            ...
            <div className="lg:col-span-3">
              ...
              <div className="opacity-0 animate-reveal delay-5 flex flex-col sm:flex-row gap-4">
                <a
                  ...
                  className="group inline-flex items-center justify-center gap-3 bg-primary hover:bg-primary-light text-white font-bold px-8 py-4 text-lg rounded-lg transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-primary/25"
                >
            ...
            <div className="hidden lg:block lg:col-span-2 opacity-0 animate-reveal delay-6">
              <div className="bg-white border border-border rounded-2xl p-8 shadow-lg shadow-black/5">
                ...
                <div className="space-y-1">
                  {[
                    ...
                    <div
                      key={item.label}
                      className={`flex items-center justify-between p-5 rounded-xl border-l-2 transition-all duration-300 hover:bg-surface-alt ${
                    ...
                    >
                      ...
                      <span className="text-text font-bold text-lg text-display">{item.price}</span>
                    </div>
                  ))}
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 lg:grid-cols-4">
            {[
              ...
              >
                <div className="text-2xl sm:text-3xl font-black text-text text-display">{stat.value}</div>
