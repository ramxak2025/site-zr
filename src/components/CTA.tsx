  ...
  return (
    <section className="relative py-24 md:py-32 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="glass-strong rounded-3xl p-8 md:p-14 lg:p-20 text-center glow-red">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-white/50 text-lg mb-10">
              При пробеге 1 500 км/мес вы переплачиваете за бензин <span className="text-white font-semibold">~4 000 ₽ каждый месяц</span>.
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a
                ...
                className="group inline-flex items-center gap-3 bg-gradient-to-r from-primary to-primary-dark hover:from-primary-light hover:to-primary text-white font-bold px-10 py-5 rounded-2xl text-lg transition-all duration-300 hover:shadow-2xl hover:shadow-primary/30 hover:-translate-y-0.5"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-2 glass hover:bg-white/10 text-white font-semibold px-10 py-5 rounded-2xl text-lg transition-all duration-300"
              >
