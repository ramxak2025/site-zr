  ...
  return (
    <section className="relative py-24 md:py-32 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="border border-white/5 bg-surface-light/80 backdrop-blur-sm p-8 md:p-16 lg:p-24">
          {/* Giant watermark */}
          <div className="absolute top-4 right-8 text-[5rem] md:text-[10rem] font-black text-white/[0.02] text-display leading-none select-none pointer-events-none">
            ГБО
          </div>
          ...
          <div className="relative max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <a
                ...
                className="inline-flex items-center justify-center gap-3 bg-primary hover:bg-primary-light text-white font-bold px-8 py-5 text-lg transition-all duration-300 hover:-translate-y-0.5"
              >
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 border border-white/10 hover:border-white/25 text-white font-semibold px-8 py-5 text-lg transition-all duration-300"
              >
                +7 988 444-44-85
              </a>
            </div>
