...
export default function Header() {
  ...
  return (
    <>
      {/* Desktop top header */}
      <header className="fixed top-0 left-0 right-0 z-50 bg-surface/95 backdrop-blur-md border-b border-white/5 hidden lg:block">
          ...
          <div className="flex items-center justify-between h-20">
            <Link href="/" className="flex items-center gap-3 group">
              ...
              <div>
                ...
                <div className="text-gray-500 text-xs leading-tight">Центр установки ГБО</div>
              </div>
            </Link>
      ...
      {/* Mobile top bar */}
      <header className="fixed top-0 left-0 right-0 z-50 bg-surface/95 backdrop-blur-md border-b border-white/5 lg:hidden">
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 bg-surface/95 backdrop-blur-md border-t border-white/10 lg:hidden bottom-nav-safe">
            ...
            if (link.isExternal) {
              return (
                <a
                  ...
                  className="flex flex-col items-center gap-0.5 px-3 py-1 text-gray-500 active:text-primary transition-colors"
                >
                  {link.icon}
