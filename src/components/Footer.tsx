        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={link.href}>
                  <Link href={link.href} className="text-white/30 hover:text-white text-sm transition-colors duration-200">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="tel:+79884444485" className="text-white/30 hover:text-white text-sm transition-colors duration-200 flex items-center gap-2.5">
                  <span className="w-1 h-1 bg-primary rounded-full shrink-0" />
                  +7 988 444-44-85
                </a>
              </li>
              <li>
                <a href="https://wa.me/79884444485" target="_blank" rel="noopener noreferrer" className="text-white/30 hover:text-white text-sm transition-colors duration-200 flex items-center gap-2.5">
                  <span className="w-1 h-1 bg-primary rounded-full shrink-0" />
                  WhatsApp
                </a>
              </li>
              <li>
                <a
                  ...
                  className="text-white/30 hover:text-white text-sm transition-colors duration-200 flex items-start gap-2.5"
                >
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/30">
              <li className="flex justify-between"><span>Пн — Чт</span><span className="text-white/50">9:00 — 19:00</span></li>
              <li className="flex justify-between"><span>Пт</span><span className="text-white/50">14:00 — 19:00</span></li>
              <li className="flex justify-between"><span>Сб — Вс</span><span className="text-white/50">9:00 — 19:00</span></li>
            </ul>
            <div className="mt-5 flex gap-2">
              <a href="https://t.me/zrauto" target="_blank" rel="noopener noreferrer" className="w-9 h-9 border border-white/10 rounded-lg flex items-center justify-center text-white/30 hover:text-primary hover:border-primary/30 transition-all duration-200" aria-label="Telegram">
              ...
              <a href="https://vk.com/zr.auto" target="_blank" rel="noopener noreferrer" className="w-9 h-9 border border-white/10 rounded-lg flex items-center justify-center text-white/30 hover:text-primary hover:border-primary/30 transition-all duration-200" aria-label="VK">
              ...
              <a href="https://youtube.com/@05auto" target="_blank" rel="noopener noreferrer" className="w-9 h-9 border border-white/10 rounded-lg flex items-center justify-center text-white/30 hover:text-primary hover:border-primary/30 transition-all duration-200" aria-label="YouTube">
