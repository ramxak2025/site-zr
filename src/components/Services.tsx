const SERVICES = [
  {
    ...
    title: "Установка ГБО",
    price: "от 23 000 ₽",
    description: "Профессиональная установка ГБО 4 поколения. Итальянское и европейское оборудование. Термопластиковые магистрали.",
  ...
  },
  {
    ...
    price: "500 ₽",
    description: "Компьютерная диагностика газовой системы. Проверка герметичности, настройка форсунок, калибровка.",
  ...
  },
  {
    ...
    title: "Ремонт ГБО",
    price: "от 1 000 ₽",
    description: "Ремонт газобаллонного оборудования любой сложности. Замена редукторов, форсунок, фильтров.",
  ...
  },
  {
    ...
    price: "от 1 500 ₽",
    description: "Регулярное ТО газовой системы. Замена фильтров, проверка герметичности, настройка.",
    ...
    <section id="services" className="py-20 md:py-28 bg-surface">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-3xl sm:text-4xl font-black text-white mb-4">Наши услуги</h2>
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Полный спектр услуг по газобаллонному оборудованию — от установки до обслуживания
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {SERVICES.map((service, i) => (
            <div
              key={i}
              className="group bg-surface-light hover:bg-surface-lighter rounded-2xl p-6 border border-white/5 hover:border-primary/20 transition-all duration-300 hover:-translate-y-1"
            >
