        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="card p-10 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a href={`tel:${contacts.phoneRaw}`} className="inline-flex items-center gap-2 text-text font-semibold hover:text-primary transition-colors">{contacts.phone}</a>
            </div>
          </div>
        </div>
      </section>
