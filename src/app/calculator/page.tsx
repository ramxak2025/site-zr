...
export const metadata: Metadata = {
  ...
  description: "Онлайн-калькулятор окупаемости установки ГБО. Узнайте, сколько вы сэкономите на топливе после перехода на газ. Расчёт за 30 секунд.",
    ...
    <div className="inner-page">
      ...
      <div className="bg-surface py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* FAQ section */}
          <div className="mt-16">
            <h2 className="text-2xl font-bold text-text mb-8">Частые вопросы</h2>
            <div className="space-y-3">
              {[
                { q: "Сколько стоит установка ГБО?", a: "Стоимость установки ГБО зависит от количества цилиндров и типа оборудования. Для 4-цилиндровых двигателей — от 23 000 ₽, для 6-цилиндровых — от 30 000 ₽, для 8-цилиндровых — от 38 000 ₽." },
                { q: "За сколько окупается ГБО?", a: "При среднем пробеге 1500 км/мес и расходе 10 л/100 км, установка ГБО окупается за 3-6 месяцев. Чем больше пробег — тем быстрее окупаемость." },
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "FAQPage",
              mainEntity: [
                { "@type": "Question", name: "Сколько стоит установка ГБО?", acceptedAnswer: { "@type": "Answer", text: "Стоимость от 23 000 ₽ для 4-цилиндровых, от 30 000 ₽ для 6-цилиндровых, от 38 000 ₽ для 8-цилиндровых двигателей." } },
                { "@type": "Question", name: "За сколько окупается ГБО?", acceptedAnswer: { "@type": "Answer", text: "При среднем пробеге 1500 км/мес установка ГБО окупается за 3-6 месяцев." } },
              ],
            }),
          }}
        />
