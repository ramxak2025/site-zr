    ...
    <div className="inner-page">
      ...
      <div className="bg-surface py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Price and CTA */}
          <div className="bg-gradient-to-r from-primary/10 to-primary/5 rounded-2xl p-6 md:p-8 border border-primary/20 mb-8">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <div>
                <div className="text-text-secondary text-sm">Стоимость установки</div>
                <div className="text-3xl font-black text-text">{formatPrice(installation.price)} ₽</div>
              </div>
              <a
    ...
    <div className="inner-page">
      ...
      <div className="bg-surface py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Pricing */}
          <div className="bg-gradient-to-r from-primary/10 to-primary/5 rounded-2xl p-6 md:p-8 border border-primary/20 mb-10">
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={p.label} className="flex items-center justify-between py-2 border-b border-border last:border-0">
                  ...
                  <span className="text-text font-bold">{p.price}</span>
                </div>
              ))}
            </div>
            <div className="mt-6">
          ...
          {related.length > 0 && (
            <div className="mb-10">
              <h2 className="text-xl font-bold text-text mb-6">Примеры установок на {brand}</h2>
              <div className="grid sm:grid-cols-2 gap-4">
                {related.map((inst) => (
                  <Link
                    key={inst.id}
